...
export async function GET() {
    const pluginData = {
        ...
        info: {
            ...
            description: "APIs used to perform supply, borrow, withdraw, adjust, and repay operations on a lending platform.",
            version: "1.0.0",
        },
        servers: [
            {
        ...
        "x-mb": {
            ...
            assistant: {
                name: "Rhea lending",
                description: "an assistant that helps users perform operations such as supply, borrow, repay, adjust, and withdraw on the Rhea Lending platform. By supplying assets, users can earn farm rewards offered by the platform, and through the borrow operation, users can borrow the assets they need.",
                instructions: `
        ...
        paths: {
                ...
                get: {
                    ...
                    parameters: [
                        ...
                        },
                        {
                            ...
                            description: "Is it necessary to use the supplied token as collateral"
                        },
                        {
                            name: "decimals",
                            in: "query",
                                                ...
                                                properties: {
                                                    ...
                                                    args: {
                                                        ...
                                                        properties: {
                                                            ...
                                                            msg: {
                                                                type: "string",
                                                                description: "Detailed input parameters for the contract call",
                                                            },
                                                            receiver_id: {
                                                                type: "string",
                                                                    ...
                                                                    properties: {
                                                                        ...
                                                                        DecreaseCollateral: {
                                                                            ...
                                                                            properties: {
                                                                                token_id: {
                                                                                    type: "string",
                                                                                    description: "Decrease the token id of collateral",
                                                                                },
                                                                                amount: {
                                                                                    type: "string",
                                                                                    description: "Decrease the amount of collateral",
                                                                                }
                                                                            }
                                                                        }
                                                                    }
                                        ...
                                        properties: {
                                            ...
                                            data: {
                                                ...
                                                properties: {
                                                    ...
                                                    args: {
                                                        type: "object",
                                                        description: "Details of the parameters required for the transaction",
                                                        properties: {
                                                            amount: {
                                                                type: "number",
                                                                description: "The amount of token to repay.",
                                                            ...
                                                            receiver_id: {
                                                                type: "string",
                                                                description: "Borrow contract ID, Just parameters",
                                                            },
                                                        }
                                                    },
                                                    contract_id: {
            ...
            "/api/tools/adjust": {
                get: {
                    ...
                    description: "Adjust the amount of collateral, Users can increase or decrease the amount of collateral",
